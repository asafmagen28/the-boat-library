...
import { listBestSellers, listAuthorPayments } from "../controllers/reports.controller.js";
...
router.get("/author-payments", authenticate, authorize(ROLES.EMPLOYEE), listAuthorPayments);
